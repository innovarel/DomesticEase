...
export default function Component() {
  const { data } = useQuery({
    queryKey: ["electricianReviews"],
    queryFn: () => getReviewsType("electrician"),
  });
  return (
    <>
        ...
        <div className="container px-4 md:px-6 grid gap-10 lg:grid-cols-2 lg:gap-20">
          <div className="space-y-6">
            ...
            <p className=" max-w-2xl text-gray-600 dark:text-gray-400 text-lg">
              Reliable and affordable electrical services for your home or
              business. From installations to repairs, our team of skilled
              electricians has you covered.
            </p>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-[#242424] rounded-lg shadow-md p-6 space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Our experienced electricians are ready to diagnose and fix any
            ...
            <div className="bg-white  rounded-lg shadow-md p-6 space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Keep your electrical system running smoothly with our regular
            ...
            <div className="bg-white  rounded-lg shadow-md p-6 space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Dont worry, were available 24/7 to handle any electrical
        ...
        <div className="container px-4 md:px-6 space-y-10 text-center">
          <div className="space-y-4">
            ...
            <p className="max-w-[600px] mx-auto text-gray-600 dark:text-gray-400 text-lg">
              ...
              with one of our skilled electricians.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Our skilled electrician will arrive on time and provide expert
                service.
              </p>
            </div>
          </div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-[#f5f5f5] ">
        <div className="container px-4 md:px-6 space-y-10 text-center">
          <div className="space-y-4">
            ...
            <p className="max-w-[600px] mx-auto text-gray-600 dark:text-gray-400 text-lg">
              Our electrician services stand out from the rest with these key
              advantages.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-[#242424] rounded-lg shadow-md p-6 space-y-4 text-left">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Our team of licensed and experienced electricians are dedicated
