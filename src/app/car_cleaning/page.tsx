...
export default function Component() {
  const { data } = useQuery({
    queryKey: ["Car cleaner"],
    queryFn: () => getReviewsType("car_cleaning"),
  });
  return (
    <>
        ...
        <div className="container px-4 md:px-6 grid gap-10 lg:grid-cols-2 lg:gap-20">
          <div className="space-y-6">
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
              Expert Car cleaner Services
            </h1>
            <p className=" max-w-2xl text-gray-600 dark:text-gray-400 text-lg">
              Reliable and affordable Car cleaning services for your home or
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-white dark:bg-black rounded-lg shadow-md p-6 space-y-4">
              ...
              <h3 className="text-xl font-semibold">
                Car cleaning Installations
              </h3>
              <p className="text-gray-600 dark:text-gray-400">
                From new construction to home renovations, we handle all your
                Car cleaning installation needs.
              </p>
            </div>
            <div className="bg-white dark:bg-[#242424] rounded-lg shadow-md p-6 space-y-4">
              <BoldIcon className="w-10 h-10 text-blue-500" />
              <h3 className="text-xl font-semibold">Car cleaning Repairs</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Our experienced Car cleaners are ready to diagnose and fix any
                Car cleaning issues in your home or business.
              </p>
            </div>
            <div className="bg-white  rounded-lg shadow-md p-6 space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Keep your Car cleaning system running smoothly with our regular
            ...
            <div className="bg-white  rounded-lg shadow-md p-6 space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Don&apos;t worry, we&apos;re available 24/7 to handle any Car
                cleaning emergencies you may have.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container px-4 md:px-6 space-y-10 text-center">
          <div className="space-y-4">
            ...
            <p className="max-w-[600px] mx-auto text-gray-600 dark:text-gray-400 text-lg">
              ...
              with one of our skilled Car cleaners.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Our skilled Car cleaner will arrive on time and provide expert
                service.
              </p>
            </div>
          </div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-[#f5f5f5] ">
        <div className="container px-4 md:px-6 space-y-10 text-center">
          <div className="space-y-4">
            ...
            <p className="max-w-[600px] mx-auto text-gray-600 dark:text-gray-400 text-lg">
              Our Car cleaner services stand out from the rest with these key
              advantages.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-[#242424] rounded-lg shadow-md p-6 space-y-4 text-left">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Our team of licensed and experienced Car cleaners are dedicated
