...
export default function Component() {
  const { data } = useQuery({
    queryKey: ["home_cleaning"],
    queryFn: () => getReviewsType("home_cleaning"),
  });
  return (
    <>
        ...
        <div className="container px-4 md:px-6 space-y-10 text-center">
          <div className="space-y-4">
            ...
            <p className="max-w-[600px] mx-auto text-gray-600 dark:text-gray-400 text-lg">
              ...
              with one of our skilled home cleaners.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Our skilled home cleaner will arrive on time and provide expert
                service.
              </p>
            </div>
          </div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-[#f5f5f5] ">
        <div className="container px-4 md:px-6 space-y-10 text-center">
          <div className="space-y-4">
            ...
            <p className="max-w-[600px] mx-auto text-gray-600 dark:text-gray-400 text-lg">
              Our home cleaner services stand out from the rest with these key
              advantages.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-[#242424] rounded-lg shadow-md p-6 space-y-4 text-left">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Our team of licensed and experienced home cleaners are dedicated
